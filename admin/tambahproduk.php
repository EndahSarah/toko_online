...
<form method="post" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <?php foreach ($datakategori as $key=>$value)://perulangan isi database ?>
    ...
    <div class="form-group">
        <label>Foto</label>
        <div class="letak-input" style="margin-bottom: 18px;">
...
if (isset($_POST['save']))
{
    ...
    VALUES('$_POST[nama]','$_POST[harga]','$_POST[berat]','$namanamafoto[0]','$_POST[stok]','$_POST[deskripsi]','$_POST[id_kategori]')");
    

    //dapat id produk barusan
   $id_produk_barusan=$koneksi->insert_id;
    ...
    foreach ($namanamafoto as $key => $tiap_nama)
    {
       ...
       // simpan ke mysql dan perlu tau id produknya berapa
